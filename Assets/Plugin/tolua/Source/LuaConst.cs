...
{
    public static string luaDir = Application.dataPath + "/Plugin/tolua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Plugin/tolua/ToLua/Lua";        //tolua lua文件目录
